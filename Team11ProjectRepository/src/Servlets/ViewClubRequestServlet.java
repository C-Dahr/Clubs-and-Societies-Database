...
public class ViewClubRequestServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writer.println(request.ClubName + "<button name='status' type='submit' value='" + true +"'>Approve</button><br>");
		writer.println(request.ClubName + "<button name='status' type='submit' value='" + false +"'>Approve</button><br>");
		writer.println("</form>");
